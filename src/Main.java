		...
		while(true) {
			...
			switch(opcao) {
				...
				case 8:
					...
					System.out.println("1 - Adicionar jogo na promo��es");
					System.out.println("2 - Remover jogo da promo��es");
					System.out.println("3 - Ver promo��es");
					...
					if(opcaoPromocao == 1) {
						...
						System.out.println("Digite o �ndice do jogo que deseja colocar em promo��o");
